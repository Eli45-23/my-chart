...
function updateLegend(data) {
  ...
  legendEl.innerHTML = [
    ...
    textPill(`Pro Grade: ${latestPayload.professional_context?.professional_grade || "n/a"} | Market: ${latestPayload.professional_context?.market_alignment || "n/a"} | Regime: ${latestPayload.professional_context?.aapl?.regime?.regime || "n/a"} ${latestPayload.professional_context?.aapl?.regime?.regime_confidence || "LOW"} | Action: ${latestPayload.professional_context?.aapl?.regime?.action_label || "WAIT_FOR_BREAKOUT"} | Chop ${latestPayload.professional_context?.aapl?.regime?.chop_score ?? "n/a"}`),
