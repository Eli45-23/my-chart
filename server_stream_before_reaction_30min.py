...
def detect_structure_reaction_zones(candles, current_price=None, timeframe="1Min"):
    ...
    settings = {
        "1Min": {"lookback": 45, "min_score": 48, "max_zones": 3, "zone_width": 0.06, "near_bps": 90},
        "5Min": {"lookback": 36, "min_score": 50, "max_zones": 3, "zone_width": 0.10, "near_bps": 140},
        "15Min": {"lookback": 28, "min_score": 48, "max_zones": 3, "zone_width": 0.18, "near_bps": 220},
    }.get(timeframe, {"lookback": 36, "min_score": 50, "max_zones": 3, "zone_width": 0.10, "near_bps": 140})
    ...
    return {
        ...
        "meta": {
            "rule": "Recent wick/body rejection zones; watch-only until confirmed by more touches or follow-through.",
